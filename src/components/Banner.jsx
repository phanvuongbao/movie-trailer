...
const Banner = () => {
  return <div className="w-full h-[700px] bg-center bg-no-repeat 
  bg-cover bg-banner relative">
    <div className="absolute w-full h-full top-0 left-0 bg-black opacity-30"/>
    <div className="w-full h-full flex items-center
    justify-center space-x-[30px] p-4 z-20 relative">
        <div className="flex flex-col space-y-5 items-baseline w-[50%]">
            <p className="text-white text-md bg-gradient-to-r from-red-600 to-red-300 to-white
            py-2 px-3 ">TV Show
            </p>
            <div className="flex flex-col space-y-4">
                ...
                <p className="text-white">
                    ...
                    adipisicing elit. Voluptates esse blanditiis enim. 
                    Quasi doloremque sapiente, recusandae enim expedita 
                    voluptatem excepturi quas blanditiis explicabo laboriosam 
                    nihil odio ab cum, rem commodi?
                </p>
